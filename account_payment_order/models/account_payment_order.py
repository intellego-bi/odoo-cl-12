    ...
    def generate_payment_file(self):
        ...
        #        "installed the related Odoo module."))
            ...
            for payline in self.payment_line_ids:
                payment_file_content = payline.name + ',' + payline.partner_id.name + ',' + payline.partner_id.document_number + ',' + payline.communication + ',' + str(payline.amount_company_currency) + ',' + payline.partner_bank_id + ',' + payline.ml_maturity_date + ',' + payline.date + ',' + '\n'
